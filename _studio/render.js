'use strict';
// hong.fun static brand-kit rasterizer. For each _studio/out/hongfun-*.html, drive headless Chrome
// with --screenshot at the asset's native size, saving hongfun-*.png to the Desktop.
...
for (const name of names) {
  ...
  const udd = path.join(os.tmpdir(), 'hongchrome_' + name + '_' + Date.now());
